...
{	
    ...
    LPC_TMR16B0->MR1          = MOTOR_INIT_SPEED;                                      //set value for duty cycle (sec 18.7.7)
		LPC_TMR16B0->MR0          = MOTOR_INIT_SPEED;                                      //set value for duty cycle (sec 18.7.7)
    ...
    LPC_TMR32B0->MR1          = MOTOR_INIT_SPEED;                                      //set value for duty cycle (sec 18.7.7)
		LPC_TMR32B0->MR0          = MOTOR_INIT_SPEED;                                      //set value for duty cycle (sec 18.7.7)
